...
namespace Agriculture.Models.ViewModels
{
    ...
    public class CustomerViewModel
    {
        ...
        public Customer Customer
        {
            get
            {
                Customer tempCustomer = new Customer() { CustomerId = this.Id, PasswordHash = this.PasswordHash, Salt = this.Salt, FirstName = this.FirstName, LastName = this.LastName, Email = this.Email, PrivilegeId = this.PrivilegeId };
                return tempCustomer;
            }
        }
